...
export function SellVehicleForm({ autofill }: { readonly autofill: ProfileAutoFill | null }) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field data-invalid={!!errors.make}>
              ...
              {errors.make && <FieldError errors={[errors.make.message ?? ""]} />}
            </Field>
            <Field data-invalid={!!errors.model}>
              <FieldLabel>Model *</FieldLabel>
              <Input {...register("model")} placeholder="e.g. Civic" />
              {errors.model && <FieldError errors={[errors.model.message ?? ""]} />}
            </Field>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field data-invalid={!!errors.offered_amount}>
            ...
            {errors.offered_amount && <FieldError errors={[errors.offered_amount.message ?? ""]} />}
          </Field>
          <Field>
