import { InquiryList } from "@/app/(main)/inquiries/_components/inquiry-list";
...
export default async function StaffInquiriesPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <InquiryList inquiries={(inquiries as Record<string, unknown>[]) ?? []} baseUrl="/dashboard/inquiries" />
    </div>
  );
}
