...
| `11 - TECH STACK` | A proposed technology arrangement when one has been selected |
| `12 - DATABASE SCHEMA` | A proposed record structure and access plan when one is needed |
