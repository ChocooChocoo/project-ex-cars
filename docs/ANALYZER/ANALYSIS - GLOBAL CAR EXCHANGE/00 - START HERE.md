...
| [14 - PHASE 6 IMPLEMENTATION PLAN](../../tasks/10.md) | The Phase 1–5 code audit, mandatory recovery gates, and Phase 6 implementation handoff. **Note:** this file lives at `docs/tasks/10.md`; use its explicit path when linking to the task. |
