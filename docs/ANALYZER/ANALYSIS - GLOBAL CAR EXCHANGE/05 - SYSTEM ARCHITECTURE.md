...
[Back to start](00%20-%20START%20HERE.md) · Previous: [02 - DOCUMENT FINDINGS](02%20-%20DOCUMENT%20FINDINGS.md) · Next: [06 - DIAGRAMS](06%20-%20DIAGRAMS.md)

## How to read this note

The first section explains what can be known about today's arrangement. The second explains the arrangement proposed by the documents. No part is called “already there” because no source code or live system was supplied. [11 - TECH STACK](11%20-%20TECH%20STACK.md) names the proposed implementation choices, and [12 - DATABASE SCHEMA](12%20-%20DATABASE%20SCHEMA.md) gives the proposed table-level design.
...
*Implementation note (10 August 2026):* in the built system, payroll runs are computed from checked attendance entries only; approved leave/overtime requests are recorded but not yet priced into runs. The implemented review order follows the provisional Head-Accountant-first sequence recorded in the start-here changelog (Q-13).
